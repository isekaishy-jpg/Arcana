...
- structured statement-block parsing for function-like bodies, with raw attached-block preservation for expression forms that still need deeper parsing

## Next Milestones

1. Replace the remaining expression/phrase parsing placeholder logic with a real parser for the frozen language.
