...
1. Replace the remaining opaque expression/phrase cases with real parsing for collection forms, assignment-target structure, chain phrases, memory phrases, and the still-ambiguous generic-bracket versus index-bracket leftovers.
