...
- Reference toolchain corpus under `grimoires/reference/toolchain/*` is tracked elsewhere as bootstrap pressure and selfhost-validation corpus, not as future grimoire architecture.
...
reference_seed: `grimoires/reference/app/winspell`
...
reference_seed: `grimoires/reference/app/spell-audio`
