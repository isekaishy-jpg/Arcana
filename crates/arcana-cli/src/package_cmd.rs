    ...
    fn package_workspace_runs_arcana_desktop_graphics_text_windows_exe_bundle() {
        ...
        write_file(
            ...
            concat!(
                ...
                "    let style = arcana_text.types.default_text_style :: (arcana_graphics.canvas.rgb :: 255, 255, 255 :: call) :: call\n",
                "    let mut builder = arcana_text.builder.open :: collection, (arcana_text.types.default_paragraph_style :: :: call) :: call\n",
                ...
                "\n",
                "fn paint_text(edit win: arcana_desktop.types.Window, read payload: ((Int, Int), (Str, Int))):\n",
                "    let pos = payload.0\n",
                "    let text = payload.1.0\n",
                "    let color = payload.1.1\n",
                "    let collection = arcana_text.fonts.default_collection :: :: call\n",
                "    let style = arcana_text.types.default_text_style :: color :: call\n",
                "    let mut builder = arcana_text.builder.open :: collection, (arcana_text.types.default_paragraph_style :: :: call) :: call\n",
                "    arcana_text.builder.push_style :: builder, style :: call\n",
                "    arcana_text.builder.add_text :: builder, text :: call\n",
                "    let mut paragraph = arcana_text.builder.build :: builder :: call\n",
                "    arcana_text.paragraphs.layout :: paragraph, 0 :: call\n",
                "    arcana_text.paragraphs.paint :: win, paragraph, pos :: call\n",
                "\n",
                "impl arcana_desktop.app.Application[Demo] for Demo:\n",
                "    fn resumed(edit self: Demo, edit cx: arcana_desktop.types.AppContext):\n",
                "        let mut main_window = (arcana_desktop.app.main_window_or_cached :: cx :: call)\n",
                ...
                "        return cx.control.control_flow\n",
                "    let mut main_window = (arcana_desktop.app.main_window_or_cached :: cx :: call)\n",
                "    let measured = measure_text :: \"desk\" :: call\n",
                "    if measured.0 <= 0:\n",
                ...
                "    paint_text :: main_window, ((12, 16), (\"desk\", label_color)) :: call\n",
        ...
        assert!(
            bundle
                .support_files
                .iter()
                .any(|path| path.starts_with("package-assets/")),
            "desktop+graphics+text bundle should stage package-owned text assets: {:?}",
    ...
    fn package_workspace_runs_arcana_desktop_record_settings_with_graphics_text_windows_exe_bundle()
    {
        ...
        write_file(
            ...
            concat!(
                ...
                "        let measure = measure_text :: \"desk\" :: call\n",
                "        let mut main_window = (arcana_desktop.app.main_window_or_cached :: cx :: call)\n",
                "        let mut settings = arcana_desktop.window.settings :: main_window :: call\n",
                "        settings.title = \"Applied\"\n",
                "        settings.bounds.min_size = (900, 620)\n",
