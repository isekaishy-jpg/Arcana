...
fn render_generated_binding_preamble(preamble: &GeneratedBindingPreamble<'_>) -> String {
    ...
    out.push_str(&format!(
        concat!(
            ...
            "    ArcanaCabiProductApiV1,\n",
            "    ArcanaViewV1,\n",
            "    copy_binding_input_view_bytes,\n",
            "    free_owned_bytes,\n",
            "    free_owned_str,\n",
            "    into_owned_bytes,\n",
            "    into_owned_str,\n",
            "    raw_view,\n",
            "    read_binding_input_bytes_arg as cabi_read_binding_input_bytes_arg,\n",
            "    read_binding_input_layout_arg as cabi_read_binding_input_layout_arg,\n",
            "    read_binding_input_utf16_arg as cabi_read_binding_input_utf16_arg,\n",
            "    read_binding_input_utf8_arg as cabi_read_binding_input_utf8_arg,\n",
            "    read_binding_input_view_arg as cabi_read_binding_input_view_arg,\n",
            "    read_binding_output_layout_arg as cabi_read_binding_output_layout_arg,\n",
...
fn render_binding_runtime_support(
    ...
    concat!(
        ...
        "    let bytes = unsafe { copy_binding_input_view_bytes(view, \"binding view\") }?;\n",
        ...
        "    unsafe { cabi_read_binding_input_view_arg(value, name, expected_family, expected_element_size) }\n",
        "}\n\n",
