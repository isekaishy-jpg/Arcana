...
- The syntax/HIR layer now captures structured top-level declarations for functions, async functions, generics/where clauses, parameter modes, and impl headers
