...
- Remaining opaque expression debt is now mostly deeper attached-block bodies, expression typing, ownership flow, and the still-ambiguous generic-bracket versus index-bracket edge cases
