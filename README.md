...
- Remaining opaque expression debt is now mostly collection literals, assignment targets, chain phrases, memory phrases, and the still-ambiguous generic-bracket versus index-bracket cases
