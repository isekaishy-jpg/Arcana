...
fn collect_arc_rel_paths(dir: Str, rel_prefix: Str) -> List[Str]:
    ...
    let mut names = fs_support.list_dir_or_empty :: dir :: call
...
export fn member_source_hash_or_zero(member_dir: Str) -> Int:
    ...
    let manifest_text = fs_support.read_text_or :: manifest_path, "" :: call
    ...
    while (rev :: :: len) > 0:
        ...
        let bytes = fs_support.read_bytes_or_empty :: full :: call
...
export fn workspace_sources_hash_or_zero(workspace_dir: Str) -> Int:
    ...
    let book_text = fs_support.read_text_or :: book_path, "" :: call
    checksum = arcana_compiler_core.fingerprint.fold_text :: checksum, book_text :: call
    let mut members = fs_support.list_dir_or_empty :: workspace_dir :: call
