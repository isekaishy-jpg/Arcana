...
fn lift_event(read ev: std.kernel.events.Event) -> Option[AppEvent]:
    return match ev:
        ...
        std.kernel.events.Event.WindowMoved(value) => Option.Some[AppEvent] :: (AppEvent.WindowMoved :: value :: call) :: call
        ...
        std.kernel.events.Event.MouseEntered => Option.Some[AppEvent] :: (AppEvent.MouseEntered :: :: call) :: call
        std.kernel.events.Event.MouseLeft => Option.Some[AppEvent] :: (AppEvent.MouseLeft :: :: call) :: call
