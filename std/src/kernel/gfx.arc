...
intrinsic fn canvas_image_create(width: Int, height: Int) -> Image = CanvasImageCreate
intrinsic fn canvas_image_replace_rgba(edit img: Image, read rgba: Array[Int]) = CanvasImageReplaceRgba
